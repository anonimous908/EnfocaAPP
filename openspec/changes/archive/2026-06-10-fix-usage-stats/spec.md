# Especificación: fix-usage-stats — Nuevo subsistema `usage-stats`

## Propósito

Obtener estadísticas precisas de uso diario (tiempo en primer plano + desbloqueos) reemplazando la lógica actual basada en `queryEvents()`/`SCREEN_INTERACTIVE` que infla datos artificialmente.
